    ...
    <div class="w-full mx-auto py-4 px-24" style="height: 600px;">
        ...
        <div class="flex justify-between">
            ...
            <div class="flex flex-col w-2/5">
                ...
                @if ($computedRegister)
                <form wire:submit.prevent='login' method="POST" class="flex flex-col w-3/4 mx-auto space-y-5 p-5">
                ...
                @else
                <form wire:submit.prevent='register' method="POST" class="flex flex-col w-3/4 mx-auto space-y-5 p-5">
                    <input type="text" name="username" class="pl-1 py-2 bg-gray-200 text-gray-600"
                        placeholder="Username">
                    <input type="text" name="password" class="pl-1 py-2 bg-gray-200 text-gray-600"
                        placeholder="Password">
